...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "faceattendacerealtime-8ca17.appspot.com"
})
        ...
        if counter != 0:
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    cv2.putText(imgBackground, str(studentInfo['section']), (910, 625),cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
